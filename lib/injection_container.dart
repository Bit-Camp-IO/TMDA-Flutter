...
class InjectionContainer {
  Future<void> init() async {
    ...
    // Use Cases
    sl.registerLazySingleton<GetNowPlayingMoviesUseCase>(() => GetNowPlayingMoviesUseCase(movieRepository: sl()));
    sl.registerLazySingleton<GetUpComingMoviesUseCase>(() => GetUpComingMoviesUseCase(movieRepository: sl()));
    sl.registerLazySingleton<GetPopularMoviesUseCase>(() => GetPopularMoviesUseCase(movieRepository: sl()));
    sl.registerLazySingleton<GetTopRatedMoviesUseCase>(() => GetTopRatedMoviesUseCase(movieRepository: sl()));
    sl.registerLazySingleton<GetMovieDetailsUseCase>(() => GetMovieDetailsUseCase(moviesRepository: sl()));
    // Movie Repository
    sl.registerLazySingleton<MoviesRepository>(() => MoviesRepositoryImpl(moviesDataSource: sl()));

    // Data Source
    sl.registerLazySingleton<MoviesDataSource>(() => MoviesDataSourceImpl(sl()));
