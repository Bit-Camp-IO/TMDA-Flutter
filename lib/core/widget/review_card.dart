...
class ReviewCard extends StatelessWidget {
  const ReviewCard({
    ...
    required this.reviewAuthorUserName,
    required this.reviewContent,
  });
  final dynamic reviewRating;
  final String reviewAuthorName;
  final String reviewAuthorUserName;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 6.h),
                  Text(
                    '${StringsManager.movieDetailsReviewTitle} ${reviewAuthorName.isEmpty ? reviewAuthorUserName : reviewAuthorName}',
